...
async function listarTablaDatosEvaluados(datos) {
  ...
  if ($.fn.DataTable.isDataTable('#tabla-DatosEvaluados')) {
      $('#tabla-DatosEvaluados').DataTable().destroy();
  }
  
  // Limpiar tbody
  $('#tabla-DatosEvaluados tbody').empty();
