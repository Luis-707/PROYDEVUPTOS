...
$evalOb = new EvaluacionesObreros([], $this);

// Pasar el ID del usuario autenticado al método sql_listar_evaluacionesOb
$sql = $evalOb->sql_listar_evaluacionesOb($idUsuarioSesion);
