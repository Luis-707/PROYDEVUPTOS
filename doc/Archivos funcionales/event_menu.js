...
$(document).on('click', '.menu-link', function() {
  ...
  if (toggler) {
    ...
    //====================================
    function abrirPlanillaEditar(cedula, periodoEvaluado){ 
