...
/* Created on:     27/11/2025 11:21:18 a.m.                     */
/*==============================================================*/
...
create table COMPETENCIAS (
   ...
   ESTADO_COMPETENCIA   VARCHAR(255)         null,
...
/*==============================================================*/
/* Index: OBJ_DESEMP_IND_PK                                     */
/*==============================================================*/
create unique index OBJ_DESEMP_IND_PK on OBJETIVOS_DESEMPENO_INDIVIDUAL (
ID_ODI
);
