  ...
  registros.forEach(item => {
    ...
    html += `
      <tr>
        ...
        <td>
          <button type="button" class="btn btn-info btn-sm" onclick="abrirPlanilla('${cedula}', '${periodoEvaluado}', '${item.id_eval_admin}')">
            Ver planilla
          </button>
          <button type="button" class="btn btn-warning btn-sm" onclick="abrirPlanillaEditar('${cedula}', '${periodoEvaluado}')">
            Editar planilla
          </button>
        </td>
      </tr>
