...
/* Created on:     18/08/2025 03:23:32 p.m.                     */
/*==============================================================*/
...
drop index PERTENECE_SEDE_FK;

drop index TIENE_AREA_FK;

drop index TIENE_CARGO_FK;

drop index ASIGNA_FK;

drop index DATOS_PERSONAS_PK;

drop table DATOS_PERSONAS;
...
drop index JEFES_SUPERIORES_PK;

drop table JEFES_SUPERIORES;
...
drop index OBJETIVOS_DESEMP_INDIV_PK;
...
drop index POSEE_ROL2_FK;

drop index POSEE_ROL_FK;

drop index POSEE_ROL_PK;

drop table POSEE_ROL;
...
drop index TIENE_JEFE_SUPERIOR_FK;

drop index TIENEN_CARGO_SUPERV_FK;
...
/* Index: TIENE_TIPO_FK                                         */
/*==============================================================*/
create  index TIENE_TIPO_FK on CARGOS (
ID_TIPO_CARGO
);
...
create table CARGOS_SUPERVISORES (
   ID_CARGOS_SUPERVISORES SERIAL               not null,
   NOMBRES_CARGOS_SUPERV VARCHAR(255)         not null,
   constraint PK_CARGOS_SUPERVISORES primary key (ID_CARGOS_SUPERVISORES)
);
...
create table DATOS_PERSONAS (
   ...
   constraint PK_DATOS_PERSONAS primary key (ID_PERSONA)
);

/*==============================================================*/
/* Index: DATOS_PERSONAS_PK                                     */
/*==============================================================*/
create unique index DATOS_PERSONAS_PK on DATOS_PERSONAS (
ID_PERSONA
);
...
/* Index: ASIGNA_FK                                             */
/*==============================================================*/
create  index ASIGNA_FK on DATOS_PERSONAS (
ID_USUARIO
);
...
/*==============================================================*/
create  index TIENE_CARGO_FK on DATOS_PERSONAS (
ID_CARGO
);
...
/* Index: TIENE_AREA_FK                                         */
/*==============================================================*/
create  index TIENE_AREA_FK on DATOS_PERSONAS (
ID_AO
);

/*==============================================================*/
/* Index: PERTENECE_SEDE_FK                                     */
/*==============================================================*/
create  index PERTENECE_SEDE_FK on DATOS_PERSONAS (
ID_UF
);
...
/* Index: IDENTIFICA_FK                                         */
/*==============================================================*/
create  index IDENTIFICA_FK on EVALUACION_ADMINISTRATIVOS (
ID_PERSONA
);
...
/* Index: MANEJA_FK                                             */
/*==============================================================*/
create  index MANEJA_FK on EVALUACION_OBREROS (
ID_PERSONA
);
...
/*==============================================================*/
/* Table: JEFES_SUPERIORES                                      */
/*==============================================================*/
create table JEFES_SUPERIORES (
   ID_JEFE_SUPERIOR     SERIAL               not null,
   CEDULA_SUPERIOR      INT4                 not null,
   CARGO_SUPERIOR       VARCHAR(50)          not null,
   constraint PK_JEFES_SUPERIORES primary key (ID_JEFE_SUPERIOR)
);

/*==============================================================*/
/* Index: JEFES_SUPERIORES_PK                                   */
/*==============================================================*/
create unique index JEFES_SUPERIORES_PK on JEFES_SUPERIORES (
ID_JEFE_SUPERIOR
);
...
/*==============================================================*/
/* Index: OBJETIVOS_DESEMP_INDIV_PK                             */
/*==============================================================*/
create unique index OBJETIVOS_DESEMP_INDIV_PK on OBJETIVOS_DESEMPENO_INDIVIDUAL (
ID_ODI
);
...
/* Table: POSEE_ROL                                             */
/*==============================================================*/
create table POSEE_ROL (
   ID_USUARIO           INT4                 not null,
   ROL_ID               INT4                 not null,
   constraint PK_POSEE_ROL primary key (ID_USUARIO, ROL_ID)
);

/*==============================================================*/
/* Index: POSEE_ROL_PK                                          */
/*==============================================================*/
create unique index POSEE_ROL_PK on POSEE_ROL (
ID_USUARIO,
ROL_ID
);
...
/* Index: POSEE_ROL_FK                                          */
/*==============================================================*/
create  index POSEE_ROL_FK on POSEE_ROL (
ID_USUARIO
);
...
/* Index: POSEE_ROL2_FK                                         */
/*==============================================================*/
create  index POSEE_ROL2_FK on POSEE_ROL (
ROL_ID
);
...
create table USUARIOS (
   ...
   ID_CARGOS_SUPERVISORES INT4                 null,
   ID_JEFE_SUPERIOR     INT4                 null,
...
/*==============================================================*/
/* Index: TIENEN_CARGO_SUPERV_FK                                */
/*==============================================================*/
create  index TIENEN_CARGO_SUPERV_FK on USUARIOS (
ID_CARGOS_SUPERVISORES
);

/*==============================================================*/
/* Index: TIENE_JEFE_SUPERIOR_FK                                */
/*==============================================================*/
create  index TIENE_JEFE_SUPERIOR_FK on USUARIOS (
ID_JEFE_SUPERIOR
);

alter table CARGOS
   add constraint FK_CARGOS_TIENE_TIP_TIPO_CAR foreign key (ID_TIPO_CARGO)
...
alter table DATOS_PERSONAS
   add constraint FK_DATOS_PE_ASIGNA_USUARIOS foreign key (ID_USUARIO)
      references USUARIOS (ID_USUARIO)
      on delete restrict on update restrict;

alter table DATOS_PERSONAS
   add constraint FK_DATOS_PE_PERTENECE_UBICACIO foreign key (ID_UF)
      references UBICACION_FISICA (ID_UF)
      on delete restrict on update restrict;

alter table DATOS_PERSONAS
   add constraint FK_DATOS_PE_TIENE_ARE_AREA_OCU foreign key (ID_AO)
      references AREA_OCUPACIONAL (ID_AO)
      on delete restrict on update restrict;

alter table DATOS_PERSONAS
   add constraint FK_DATOS_PE_TIENE_CAR_CARGOS foreign key (ID_CARGO)
...
alter table EVALUACION_ADMINISTRATIVOS
   add constraint FK_EVALUACI_IDENTIFIC_DATOS_PE foreign key (ID_PERSONA)
      references DATOS_PERSONAS (ID_PERSONA)
      on delete restrict on update restrict;
...
alter table EVALUACION_OBREROS
   add constraint FK_EVALUACI_MANEJA_DATOS_PE foreign key (ID_PERSONA)
      references DATOS_PERSONAS (ID_PERSONA)
      on delete restrict on update restrict;
...
alter table POSEE_ROL
   add constraint FK_POSEE_RO_POSEE_ROL_USUARIOS foreign key (ID_USUARIO)
      references USUARIOS (ID_USUARIO)
      on delete restrict on update restrict;

alter table POSEE_ROL
   add constraint FK_POSEE_RO_POSEE_ROL_ROLES_SI foreign key (ROL_ID)
      references ROLES_SISTEMA (ROL_ID)
      on delete restrict on update restrict;

alter table USUARIOS
   add constraint FK_USUARIOS_TIENEN_CA_CARGOS_S foreign key (ID_CARGOS_SUPERVISORES)
      references CARGOS_SUPERVISORES (ID_CARGOS_SUPERVISORES)
      on delete restrict on update restrict;

alter table USUARIOS
   add constraint FK_USUARIOS_TIENE_JEF_JEFES_SU foreign key (ID_JEFE_SUPERIOR)
      references JEFES_SUPERIORES (ID_JEFE_SUPERIOR)
      on delete restrict on update restrict;
