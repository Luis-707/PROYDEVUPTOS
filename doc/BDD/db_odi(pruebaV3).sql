...
/* Created on:     08/09/2025 09:55:26 a.m.                     */
/*==============================================================*/
...
drop index ASIGNAR_EVALUADOR_FK;

drop index ASIGNAR_FK;

drop index ASIGNADOS_EVALUADOR_PK;

drop table ASIGNADOS_EVALUADOR;

drop index SE_ASIGNA_EVAL_FK;

drop index SE_ASIGNA_SUPERVISOR_FK;

drop index ASIGNADOS_SUPERVISOR_PK;

drop table ASIGNADOS_SUPERVISOR;
...
/*==============================================================*/
/* Table: ASIGNADOS_EVALUADOR                                   */
/*==============================================================*/
create table ASIGNADOS_EVALUADOR (
   ID_ASIG_EVALUADOR    SERIAL               not null,
   ID_EVALUADOR         INT4                 not null,
   ID_EVALUADO          INT4                 not null,
   constraint PK_ASIGNADOS_EVALUADOR primary key (ID_ASIG_EVALUADOR)
);

/*==============================================================*/
/* Index: ASIGNADOS_EVALUADOR_PK                                */
/*==============================================================*/
create unique index ASIGNADOS_EVALUADOR_PK on ASIGNADOS_EVALUADOR (
ID_ASIG_EVALUADOR
);
...
/* Index: ASIGNAR_FK                                            */
/*==============================================================*/
create  index ASIGNAR_FK on ASIGNADOS_EVALUADOR (
ID_EVALUADOR
);

/*==============================================================*/
/* Index: ASIGNAR_EVALUADOR_FK                                  */
/*==============================================================*/
create  index ASIGNAR_EVALUADOR_FK on ASIGNADOS_EVALUADOR (
ID_EVALUADO
);

/*==============================================================*/
/* Table: ASIGNADOS_SUPERVISOR                                  */
/*==============================================================*/
create table ASIGNADOS_SUPERVISOR (
   ID_ASIG_SUPERVISOR   SERIAL               not null,
   ID_EVALUADOR         INT4                 not null,
   ID_SUPERVISOR        INT4                 not null,
   constraint PK_ASIGNADOS_SUPERVISOR primary key (ID_ASIG_SUPERVISOR)
);

/*==============================================================*/
/* Index: ASIGNADOS_SUPERVISOR_PK                               */
/*==============================================================*/
create unique index ASIGNADOS_SUPERVISOR_PK on ASIGNADOS_SUPERVISOR (
ID_ASIG_SUPERVISOR
);

/*==============================================================*/
/* Index: SE_ASIGNA_SUPERVISOR_FK                               */
/*==============================================================*/
create  index SE_ASIGNA_SUPERVISOR_FK on ASIGNADOS_SUPERVISOR (
ID_SUPERVISOR
);

/*==============================================================*/
/* Index: SE_ASIGNA_EVAL_FK                                     */
/*==============================================================*/
create  index SE_ASIGNA_EVAL_FK on ASIGNADOS_SUPERVISOR (
ID_EVALUADOR
);
...
create table CARGOS_EVALUADORES (
   ...
   CARGOS_EVALUADORES   VARCHAR(255)         not null,
...
create table CARGOS_EVALUADOS (
   ...
   CARGOS_EVALUADOS     VARCHAR(255)         not null,
...
create table CARGOS_SUPERVISORES (
   ...
   CARGOS_SUPERVISORES  VARCHAR(255)         not null,
...
alter table ASIGNADOS_EVALUADOR
   add constraint FK_ASIGNADO_ASIGNAR_EVALUADO foreign key (ID_EVALUADOR)
      references EVALUADORES (ID_EVALUADOR)
      on delete restrict on update restrict;

alter table ASIGNADOS_EVALUADOR
   add constraint FK_ASIGNADO_ASIGNAR_E_EVALUADO foreign key (ID_EVALUADO)
      references EVALUADOS (ID_EVALUADO)
      on delete restrict on update restrict;

alter table ASIGNADOS_SUPERVISOR
   add constraint FK_ASIGNADO_SE_ASIGNA_EVALUADO foreign key (ID_EVALUADOR)
      references EVALUADORES (ID_EVALUADOR)
      on delete restrict on update restrict;

alter table ASIGNADOS_SUPERVISOR
   add constraint FK_ASIGNADO_SE_ASIGNA_SUPERVIS foreign key (ID_SUPERVISOR)
