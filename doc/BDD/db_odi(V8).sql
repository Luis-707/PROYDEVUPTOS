...
/* Created on:     22/10/2025 10:45:46 a. m.                    */
/*==============================================================*/
...
drop index OBJETIVOS_DESEMP_INDIVIDUAL_PK;
...
/* Index: ANADE_FK                                              */
/*==============================================================*/
create  index ANADE_FK on EVALUACION_OBJETIVOS (
ID_EVAL_ADMIN
);
...
/*==============================================================*/
/* Index: OBJETIVOS_DESEMP_INDIVIDUAL_PK                        */
/*==============================================================*/
create unique index OBJETIVOS_DESEMP_INDIVIDUAL_PK on OBJETIVOS_DESEMPENO_INDIVIDUAL (
ID_ODI
);
...
alter table EVALUACION_OBJETIVOS
   add constraint FK_EVALUACI_ANADE_EVALUACI foreign key (ID_EVAL_ADMIN)
      references EVALUACION_ADMINISTRATIVOS (ID_EVAL_ADMIN)
      on delete restrict on update restrict;
