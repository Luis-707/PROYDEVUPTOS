...
<div class="container mt-4">
  ...
  <!-- Sección E: Comentarios y Conformidad (Solo Lectura) -->
  <div class="row mt-5">
    <div class="col-md-12">
      <h6 class="text-muted">SECCIÓN "E": COMENTARIOS Y CONFORMIDAD</h6>
...
<script src="views/js/planilla_resultados.js"></script>