...
<div class="container my-4">
    <form id="formulario_planilla_obrero_editar" onsubmit="event.preventDefault(); validar_form_editar_obrero(1);">
        <div class="card shadow-sm">
            <div class="card-header text-center">
                <h5 class="mb-0">OFICINA DE GESTIÓN HUMANA</h5>
                <p class="mb-0 small-text">Editar Evaluación de Desempeño Laboral - Nivel Obrero</p>
            </div>
...
<script src="views/js/planilla_obreros_editar.js"></script>
