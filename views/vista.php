...
if (isset($_POST['file']) && isset($_POST['idElemento'])) {
    ...
    $allowedFiles = [
        ...
        'comentarios_obreros' => $DIR. 'Comentarios_Obreros.php',
        'resultados' => $DIR. 'Resultados.php',
        'resultados_obreros' => $DIR. 'Resultados_Obreros.php',
        'planilla' => $DIR. 'planilla.php',
        'planilla_obrero' => $DIR. 'Planilla_Obrero.php',
        'evaluacion_obreros' => $DIR. 'evaluacion_obreros.php',
