...
class Planilla_resultados {
    ...
    public function getIdEvalAdmin_resultados(): int {
        return $this->id_eval_admin;
    }
    
    public function setIdEvalAdmin_resultados(int $id): void {
    ...
    // =============================
    public static function sql_relaciones_resultados(string $cedula): string {
        return sprintf(
            "SELECT 
    ...
    // =============================
    public function sql_buscar_resultados(): string {
        return sprintf(
    ...
    public function buscarEvaluacion() {
        if ($this->conexion != null && $this->cedula_usuario !== "") {
            return $this->conexion->ejecutarConsultaBdds($this->sql_buscar_resultados());
        }
        return [];
    }
    ...
    // Objetivos
    // =============================
    public static function sql_objetivos_resultados(string $cedula, string $idEvalAdmin): string {
        return sprintf(
            "SELECT 
                odi.id_odi,
                odi.nombre_objetivo,
