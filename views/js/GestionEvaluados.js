        ...
        <td class="acciones">
          <div class="acciones-icons">
            <img src="img/iconos/actualizar.png" 
                 onclick="abrirModalEditarEvaluado(${cedula})" />
            <img src="img/iconos/eliminar.png" 
                 onclick="eliminarEvaluado(${item.cedula_usuario},${item.id_usuario})" />
          </div>
        </td>
      </tr>
    `;
...
async function actualizarEvaluado() {
  ...
  const resp = await microApi('controlador/?a_evaluados', datos);
  listarTablaEvaluados(resp);
